...
export default function Footer({ footer }: FooterProps) {
  ...
  return (
    <footer className="bg-[#1e3a8a] pt-8 pb-[calc(env(safe-area-inset-bottom)+150px)] md:py-8 px-6 md:px-14 flex flex-col md:flex-row justify-between items-center gap-3 text-center md:text-left">
