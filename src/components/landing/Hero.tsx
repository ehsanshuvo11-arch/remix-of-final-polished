  ...
  return (
    ...
    >
      ...
      <div className="max-w-[900px] text-center relative z-10">
        ...
        <p
          lang="en"
          className="font-sans-eyebrow text-[9px] tracking-[0.35em] text-primary-foreground/55 mt-4 mb-8 md:mt-0 md:text-[11px] md:tracking-[4px] md:mb-5 md:text-accent uppercase font-normal"
