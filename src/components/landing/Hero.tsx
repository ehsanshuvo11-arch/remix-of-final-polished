  ...
  return (
    ...
    >
      ...
      <div className="max-w-[900px] text-center relative z-10">
        ...
        <div className="mb-6 md:mb-8" style={{ animation: 'fadeUp 0.9s cubic-bezier(0.22,1,0.36,1) 1s forwards', opacity: 0 }}>
          <MagneticButton
            onClick={onPuzzleOpen}
            className={`play-btn group inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-10 py-1.5 sm:py-4.5 min-w-[180px] sm:min-w-[320px] bg-transparent border-[1.5px] border-accent/50 text-accent ${isBn ? 'text-[12px] sm:text-[18px] tracking-[0.5px] normal-case font-medium leading-[1.3]' : 'text-[9px] sm:text-[13px] tracking-[2px] sm:tracking-[2.5px] uppercase font-normal'} rounded-sm relative overflow-hidden transition-all duration-700 ease-out hover:text-primary-foreground hover:border-accent hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(251,146,60,0.3)] active:scale-[0.97] h-[34px] sm:h-[52px] before:content-[''] before:absolute before:inset-0 before:bg-accent before:scale-x-0 before:origin-left before:transition-transform before:duration-700 hover:before:scale-x-100`}
        ...
        <div className="flex flex-row gap-3 sm:gap-4 justify-center items-center flex-wrap" style={{ animation: 'fadeUp 0.9s cubic-bezier(0.22,1,0.36,1) 1.1s forwards', opacity: 0 }}>
          <MagneticButton
            ...
            className={`inline-flex items-center justify-center px-3 sm:px-11 py-1.5 sm:py-4 min-w-[110px] sm:min-w-[220px] ${isBn ? 'text-[11px] sm:text-[18px] tracking-[0.5px] normal-case leading-[1.3]' : 'text-[9px] sm:text-[13px] tracking-[1.5px] sm:tracking-[2.5px] uppercase'} font-medium rounded-sm bg-accent text-primary relative overflow-hidden transition-all duration-700 ease-out hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(251,146,60,0.4),inset_0_1px_0_rgba(255,255,255,0.35)] active:scale-[0.97] h-[34px] sm:h-[52px] before:content-[''] before:absolute before:inset-0 before:bg-primary-foreground/15 before:scale-x-0 before:origin-left before:transition-transform before:duration-700 hover:before:scale-x-100`}
          ...
          <MagneticButton
            ...
            className={`inline-flex items-center justify-center px-3 sm:px-11 py-1.5 sm:py-4 min-w-[110px] sm:min-w-[220px] ${isBn ? 'text-[11px] sm:text-[18px] tracking-[0.5px] normal-case font-medium leading-[1.3]' : 'text-[9px] sm:text-[13px] tracking-[1.5px] sm:tracking-[2.5px] uppercase font-normal'} rounded-sm border-[1.5px] border-accent/50 text-accent relative overflow-hidden transition-all duration-700 ease-out hover:text-primary-foreground hover:border-accent hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(251,146,60,0.3)] active:scale-[0.97] h-[34px] sm:h-[52px] before:content-[''] before:absolute before:inset-0 before:bg-accent before:scale-x-0 before:origin-left before:transition-transform before:duration-700 hover:before:scale-x-100`}
