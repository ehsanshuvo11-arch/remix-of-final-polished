      ...
      <div className="max-w-[900px] text-center relative z-10">
        ...
        {(() => {
          ...
          return (
            <h1
              lang="en"
              className="hero-headline font-heading font-light text-primary-foreground mb-6 md:mb-6 text-[clamp(40px,10.5vw,120px)] md:text-[clamp(32px,8vw,96px)] leading-[1.02] md:leading-[1.08] whitespace-nowrap text-center [&_span]:!mr-0 md:[&_span]:!mr-[unset]"
              style={{
