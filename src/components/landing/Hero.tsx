      ...
      <div className="max-w-[900px] text-center relative z-10">
        ...
        {(() => {
          ...
          return (
            <h1
              lang="en"
              className="hero-headline font-heading font-light text-primary-foreground mb-6 md:mb-6 text-[clamp(36px,9.5vw,120px)] md:text-[clamp(48px,8vw,96px)] leading-[1.02] md:leading-[1.08] whitespace-nowrap text-center -ml-[0.21em] md:ml-0"
              style={{
            ...
            >
              ...
              <RevealText
                as="span"
                delay={line2Delay}
                className="hero-accent-line block pt-4 text-[clamp(48px,13vw,108px)] md:text-[clamp(42px,7vw,84px)] text-accent italic whitespace-nowrap [word-spacing:normal]"
                stagger={STAGGER}
              >
                {line2}
              </RevealText>
