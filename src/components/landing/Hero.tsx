      ...
      <div className="max-w-[900px] text-center relative z-10">
        ...
        {(() => {
          ...
          return (
            <h1
              lang="en"
              className="hero-headline font-heading font-light text-primary-foreground mb-6 md:mb-6 text-[clamp(28px,7.4vw,120px)] md:text-[clamp(32px,8vw,96px)] leading-[1.05] md:leading-[1.08] whitespace-nowrap text-center"
              style={{
            ...
            >
              ...
              <RevealText
                as="span"
                delay={line2Delay}
                className="hero-accent-line block pt-4 text-[clamp(32px,8.5vw,108px)] md:text-[clamp(32px,7vw,84px)] text-accent italic whitespace-nowrap [word-spacing:normal]"
                stagger={STAGGER}
              >
                {line2}
              </RevealText>
