          ...
          return (
            ...
            >
              ...
              <RevealText
                as="span"
                delay={line2Delay}
                className="hero-accent-line block text-2xl italic mt-3 mb-20 md:mt-0 md:mb-0 md:pt-4 md:text-[clamp(42px,7vw,84px)] text-accent whitespace-nowrap [word-spacing:normal]"
                stagger={STAGGER}
              >
                {line2}
              </RevealText>
